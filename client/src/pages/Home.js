...
import Hero from '../assets/doubleUpHero.png'
  ...
  return (
    <div className="grid grid-nogutter surface-0 text-800">
      ...
      <div className="col-12 md:col-7 overflow-hidden">
        <img src={Hero} alt="hero-1" className="md:ml-auto block md:h-full" style={{ clipPath: 'polygon(8% 0, 100% 0%, 100% 100%, 0 100%)'}} width={1250} />
      </div>
    </div>
  );
}